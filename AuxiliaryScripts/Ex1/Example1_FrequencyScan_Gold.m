...
for ii = 1 : 4
    ...
    load(strcat('Straights/HeightNo',num2str(4),'_',num2str(fVec(ii)),'G.mat'))
    close 
...
print(gcf,'-depsc',strcat('Straights/','ScanG',num2str(ii)))
save(strcat('StraightScanG',num2str(ii),'.mat'))
%%
clearvars -except ii
end