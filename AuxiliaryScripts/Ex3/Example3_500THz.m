%% Silver, 500 THz Random radius, random height, random rotation
...
given_frequency = 500; %Frequency in THz
...
for numS = 1 : NumberOfSamples
    ...
    FreeformMetalBFGS(Var,pcurve,1,alpha,strcat('Samples',num2str(given_frequency),'/','SampleNo',num2str(numS)));
end
