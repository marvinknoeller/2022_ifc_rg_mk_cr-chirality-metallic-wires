...
for ii = 1:4
    ...
    load(strcat('GoldCurve',num2str(ii),'.mat'))
    close 
    scalVec = [1.1, .75, 0.39 , 0.32 ];
    scal = scalVec(ii);
...
print(gcf,'-depsc',strcat('Ex2ScanGold',num2str(ii)))

if exist(strcat('Example2Gold',num2str(ii))) ~= 2
    save(strcat('Example2Gold',num2str(ii),'.mat'))
end
%%
clearvars -except ii
end